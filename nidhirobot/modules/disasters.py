...
from nidhirobot import (DEV_USERS, OWNER_ID, DRAGONS, SUPPORT_CHAT, DEMONS,
                          TIGERS, WOLVES, dispatcher)
from nidhirobot.modules.helper_funcs.chat_status import (dev_plus, sudo_plus,
                                                           whitelist_plus)
...
ELEVATED_USERS_FILE = os.path.join(os.getcwd(),
                                   'nidhirobot/elevated_users.json')
