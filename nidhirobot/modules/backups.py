...
import nidhirobot.modules.sql.notes_sql as sql
from nidhirobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from nidhirobot.__main__ import DATA_IMPORT
from nidhirobot.modules.helper_funcs.chat_status import user_admin
from nidhirobot.modules.helper_funcs.alternate import typing_action

# from nidhirobot.modules.rules import get_rules
import nidhirobot.modules.sql.rules_sql as rulessql

# from nidhirobot.modules.sql import warns_sql as warnssql
import nidhirobot.modules.sql.blacklist_sql as blacklistsql
from nidhirobot.modules.sql import disable_sql as disabledsql

# from nidhirobot.modules.sql import cust_filters_sql as filtersql
# import nidhirobot.modules.sql.welcome_sql as welcsql
import nidhirobot.modules.sql.locks_sql as locksql
from nidhirobot.modules.connection import connected
...
def export_data(update, context):
    ...
    f = open("nidhirobot{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("nidhirobot{}.backup".format(chat_id), "rb"),
